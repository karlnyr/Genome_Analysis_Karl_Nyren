...
OUTPUT_DIR='/home/karlnyr/Genome_Analysis/Genome_Assembly/spades_combined_assembly'
READ_1_EXT='*1_clean.fq.gz'
READ_2_EXT='*2_clean.fq.gz'

spades.py \
    --pe<#>-1 $ILLUMINA_READS_DIR$READ_1_EXT --pe<#>-2 $ILLUMINA_READS_DIR$READ_2_EXT \
    --nanopore $NANOPORE_READS_DIR \
    --untrusted-contigs $OLD_ASSEMBLY_DIR \
    -o $OUTPUT_DIR
